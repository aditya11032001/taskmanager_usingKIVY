...
class DialogContent(MDBoxLayout):
    ...
    #This function will get the data and saves in a friendly form
...
class MainApp(MDApp):
    ...
    # del tasks
    def del_task(self,task,task_date):
        # print(task.text,task_date)
        deleted_task=db.del_task(task.text,task_date)
        self.root.ids['container'].add_widget(ListItemWithCheckbox(pk=deleted_task[0], text='[b]' + deleted_task[1] + '[/b]',secondary_text=deleted_task[2]))
        task.text=''
